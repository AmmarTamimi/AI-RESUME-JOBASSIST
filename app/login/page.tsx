      ...
      >
        ...
        <div className="bg-card border border-border rounded-2xl shadow-xl p-4 sm:p-5 md:p-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button onClick={()=>handleGithubLogin()} className="flex items-center justify-center gap-1.5 px-2 py-1.5 border border-border rounded-lg hover:bg-secondary transition-colors text-[11px] sm:text-xs font-medium">
