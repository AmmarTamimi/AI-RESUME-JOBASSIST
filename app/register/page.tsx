      ...
      >
        ...
        <div className="bg-card border border-border rounded-2xl shadow-xl p-4 sm:p-5 md:p-6">
          ...
          <div className="text-center mb-3 sm:mb-4">
            <h1 className="text-lg sm:text-xl font-bold text-foreground">Create your account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            {/* Full Name */}
            <div>
              <label htmlFor="fullName" className="block text-[11px] sm:text-xs font-medium text-foreground mb-0.5">
                Full Name
              </label>
              <div className="relative">
            ...
            {/* Password */}
            <div>
              <label htmlFor="password" className="block text-[11px] sm:text-xs font-medium text-foreground mb-0.5">
                Password
              </label>
              <div className="relative">
              ...
              {formData.password && (
                <div className="mt-0.5 flex items-center gap-1">
                  ...
                  <span className={cn("text-[10px]", passwordValid ? "text-emerald-500" : "text-amber-500")}>
                    At least 8 characters
                  </span>
                </div>
              )}
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="confirmPassword" className="block text-[11px] sm:text-xs font-medium text-foreground mb-0.5">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground" />
              ...
              {formData.confirmPassword && (
                <div className="mt-0.5 flex items-center gap-1">
                  ...
                  <span className={cn("text-[10px]", passwordsMatch ? "text-emerald-500" : "text-destructive")}>
                    {passwordsMatch ? "Passwords match" : "Passwords don't match"}
                  </span>
                </div>
              )}
          ...
          <div className="grid grid-cols-2 gap-2">
            <button onClick={handleGoogleSignup} className="flex items-center justify-center gap-1.5 px-2 py-1.5 border border-border rounded-lg hover:bg-secondary transition-colors text-[11px] sm:text-xs font-medium">
